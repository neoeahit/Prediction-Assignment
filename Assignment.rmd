...
The goal of your project is to predict the manner in which people did the exercise. This is the "classe" variable in the training set. Below is a report describing how I built your model, and performed analysis. I will be happy if in my new model the error is less than 1% 
